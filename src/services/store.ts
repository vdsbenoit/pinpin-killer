...
export const useStore = defineStore(
  ...
  () => {
    // fixme
    const qrSalt = ref('')
    ...
    return { qrSalt, newbie, username, level, currentMissionIndex, poolMissions, finalMissions, winner, checkSalt, initMissions, getCurrentMisson, isWinner}
  },
  { persist: true }
)